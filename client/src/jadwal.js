                     ...
                     <Paper sx={{ padding: 1, backgroundColor: '#FFFFFF', width: '100%', minHeight: '450px', minWidth:'500px' }}>
                        ...
                        <TableContainer component={Paper} sx={{ backgroundColor: '#1E376D', color: 'white', borderRadius: '10px', maxWidth: '600px', margin: '0 auto', padding: '10px' }}>
                            <Table>
                                <TableBody>
                                    <TableRow>
                                        <TableCell sx={{ color: 'white', borderBottom: '1px solid rgba(255, 255, 255, 0.3)' }}>Tanggal :</TableCell>
                                        <TableCell sx={{ color: 'white', borderBottom: '1px solid rgba(255, 255, 255, 0.3)' }}>22 Juli 2024</TableCell>
                                    </TableRow>
                                    <TableRow>
                                        <TableCell sx={{ color: 'white', borderBottom: '1px solid rgba(255, 255, 255, 0.3)' }}>Waktu :</TableCell>
                                        <TableCell sx={{ color: 'white', borderBottom: '1px solid rgba(255, 255, 255, 0.3)' }}>Senin 09.00 - 11.30</TableCell>
                                    </TableRow>
                                    <TableRow>
                                        <TableCell sx={{ color: 'white' }}>Lokasi :</TableCell>
                                        <TableCell sx={{ color: 'white' }}>Aula Gedung Utama</TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        </TableContainer>
